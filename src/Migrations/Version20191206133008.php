 ...
 */
final class Version20191206133008 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE host_place (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, address LONGTEXT NOT NULL, INDEX IDX_D77F1E3E7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
